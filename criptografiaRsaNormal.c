...
int criptografar(char palavra[], int cont, int i, char alfabeto[], int contAlfabeto, int e, int n, int convertido[]) // criptografa a mensagem e salva no diretorio
{
    if (cont == i)
    {
...
void frase(char palavra[], int i, char alfabeto[]) // le a mensagem que o usuario quer encriptar
{
    scanf("%c", &palavra[i]);
    if (palavra[i] == '\n')
    {
